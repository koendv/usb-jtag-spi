...
#define DEF_USB_EP1_FS_SIZE        64                                           /* 端点1大小 */
#define DEF_USB_EP1_HS_SIZE        512                                          /* 端点1大小 */
#define DEF_USB_EP2_FS_SIZE        64                                           /* 端点2全速模式大小 */
#define DEF_USB_EP2_HS_SIZE        512                                          /* 端点2高速模式大小 */
#define DEF_USB_EP3_FS_SIZE        64                                           /* 端点3全速模式大小 */
#define DEF_USB_EP3_HS_SIZE        512                                          /* 端点3高速模式大小 */
#define DEF_USB_EP4_FS_SIZE        64                                           /* 端点4全速模式大小 */
#define DEF_USB_EP4_HS_SIZE        512                                          /* 端点4高速模式大小 */
#define DEF_USB_EP5_FS_SIZE        64                                           /* 端点5全速模式大小 */
#define DEF_USB_EP5_HS_SIZE        512                                          /* 端点5高速模式大小 */
#define DEF_USB_EP6_FS_SIZE        64                                           /* 端点6全速模式大小 */
#define DEF_USB_EP6_HS_SIZE        512                                          /* 端点6高速模式大小 */
#define DEF_USB_EP7_FS_SIZE        64                                           /* 端点7全速模式大小 */
#define DEF_USB_EP7_HS_SIZE        512                                          /* 端点7高速模式大小 */
#define DEF_USB_EP8_FS_SIZE        64                                           /* 端点8全速模式大小 */
#define DEF_USB_EP8_HS_SIZE        512                                          /* 端点8高速模式大小 */
...
extern volatile UINT8  FLAG_Send;                                               /* USB发送标志位  */


/******************************************************************************/
/* 变量外扩 */
extern __attribute__ ((aligned(16))) UINT8 EP0_Databuf[ USBHS_UEP0_SIZE ]; 		  /*端点0数据收发缓冲区*/
extern __attribute__ ((aligned(16))) UINT8 EP0_Databuf[ USBHS_UEP0_SIZE ]          __attribute__((section(".DMADATA"))); /*端点0数据收发缓冲区*/
extern __attribute__ ((aligned(16))) UINT8 EP1_Rx_Databuf[ DEF_USB_EP1_FS_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点1数据接收缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP1_Tx_Databuf[ DEF_USB_EP1_FS_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点1数据发送缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP2_Rx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点2数据接收缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP2_Tx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点2数据发送缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP3_Rx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点3数据接收缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP3_Tx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点3数据发送缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP4_Rx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点4数据接收缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP4_Tx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点4数据发送缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP5_Tx_Databuf[ DEF_USB_EP5_FS_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点5数据发送缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP6_Rx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点6数据接收缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP6_Tx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点6数据发送缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP7_Tx_Databuf[ DEF_USB_EP7_FS_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点7数据发送缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP8_Rx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点8数据接收缓冲区 */
extern __attribute__ ((aligned(16))) UINT8 EP8_Tx_Databuf[ USBHS_MAX_PACK_SIZE ]   __attribute__((section(".DMADATA"))); /* 端点8数据发送缓冲区 */
...
extern volatile UINT16 USBHS_Up_PackLenMax;                                     /* USB2.0高速设备当前允许上传的包长度最大值(全速64高速512) */
